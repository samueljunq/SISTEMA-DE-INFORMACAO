...
public class FormSistema extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
       if ( txtProduto . getText (). equals ( "" ) || txtQtd . getText (). equals ( "" ))
           ...
           Produto novoProduto = novoProduto ();
           ...
           mostraPilha(minhaPilha,listaPilha);
       }
        ...
        while(!minhaPilha.isEmpty()){
          ...
          if(p.getDescricao().equals(txtProduto.getText())){
              if ( p . getQuantidade () >= Integer . parseInt ( txtQtd . getText ())){
                ...
                pag.setQuantidade ( p . getQuantidade () - Integer . parseInt ( txtQtd . getText ()));
                minhaPilha.push(p);
                txtProduto . setText ( "" );
                txtQtd . setText ( "" );
                mostraPilha ( minhaPilha , listaPilha );
                JTextArea listaAux = null;
                mostraPilha(pilhaAuxiliar ,listaAux);
              break;
              } else  if ( p . getQuantidade () < Integer . parseInt ( txtQtd . getText ())){
                p = minhaPilha . pop ();
                JOptionPane . showMessageDialog ( rootPane , "Estoque não é suficiente, todos os " + p . getQuantidade ()+ " disponiveis foram removidos do estoque!" );
                txtProduto . setText ( "" );
                txtQtd . setText ( "" );
                mostraPilha ( minhaPilha , listaPilha );
                  JTextArea listaAux = null;
     ...
     */
        ...
        //<editor-fold defaultstate="collapsed" desc=" Código de configuração de aparência (opcional) ">
