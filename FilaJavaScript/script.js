 ...
 function adicionarElemento() {
    ...
    // Utilizando o IF com condição diferente proposta pelo código original
    // variavel novoNome == "vazia" && variavel novoCpf "vazia"
    // se qualquer uma das condições estiver vazias ela será verdadeira
    if(novoNome.value=="" ||  novoCpf.value == ""){
         alert("Preencha todos os Campos!");
    }
    //joguei as condições acima abaixo no Else para caso nenhuma das condições acimas forem verdadeira compilar a condição
    else
      alert("Fila cheia:(");
...
//--------------------------------------------------------------------------------------------
 ...
 function buscarCpf() {
    ...
    let atendimento = new Atendimento(); // pesquisa apenas por CP
