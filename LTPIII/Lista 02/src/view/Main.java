...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		// produtos
		Product arroz = new Product("Arroz, Albarusca", 7, 20, true);
		Product feijao = new Product("Feijão, Tatiana", 7, 25, true);
		Product carne = new Product("Carne, Contra-Filé", 7, 35, true);
		Product cerveja = new Product("Cerveja, Skol Lata", 7, 30, true);
